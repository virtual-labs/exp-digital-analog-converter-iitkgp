...
function switchchange() {
	...
	if (image3.getAttribute('src') == "./images/off.png" && image2.getAttribute('src') == "./images/off.png" && image1.getAttribute('src') == "./images/off.png" && image0.getAttribute('src') == "./images/off.png") { //0
		vo = (rf / r1) * (vref / 2) * ((b3_3 / 1) + (b2_2 / 2) + (b1_1 / 4) + (b0_0 / 8));
	...
	if (image3.getAttribute('src') == "./images/off.png" && image2.getAttribute('src') == "./images/off.png" && image1.getAttribute('src') == "./images/off.png" && image0.getAttribute('src') == "./images/on.png") {//1
		vo = (rf / r1) * (vref / 2) * ((b3_3 / 1) + (b2_2 / 2) + (b1_1 / 4) + (b0_0 / 8));
		//vo=(rf/r1)*((vref*b3_3/1)+(vref*b2_2/2)+(vref*b1_1/4)+(vref*b0_0/8));
		//resln=(rf/r1)*(vref*b0_0/8);//weighting of LSB   
		resln = (vref / 16);//weighting of LSB
	...
	if (image3.getAttribute('src') == "./images/off.png" && image2.getAttribute('src') == "./images/off.png" && image1.getAttribute('src') == "./images/on.png" && image0.getAttribute('src') == "./images/off.png") {//2
		vo = (rf / r1) * (vref / 2) * ((b3_3 / 1) + (b2_2 / 2) + (b1_1 / 4) + (b0_0 / 8));
		//vo=(rf/r1)*((vref*b3_3/1)+(vref*b2_2/2)+(vref*b1_1/4)+(vref*b0_0/8));
		//resln=(rf/r1)*(vref*b0_0/8);//weighting of LSB   
		resln = (vref / 16);//weighting of LSB		
	...
	if (image3.getAttribute('src') == "./images/off.png" && image2.getAttribute('src') == "./images/off.png" && image1.getAttribute('src') == "./images/on.png" && image0.getAttribute('src') == "./images/on.png") {//3
		vo = (rf / r1) * (vref / 2) * ((b3_3 / 1) + (b2_2 / 2) + (b1_1 / 4) + (b0_0 / 8));
		//vo=(rf/r1)*((vref*b3_3/1)+(vref*b2_2/2)+(vref*b1_1/4)+(vref*b0_0/8));
		//resln=(rf/r1)*(vref*b0_0/8);//weighting of LSB   
		resln = (vref / 16);//weighting of LSB
	...
	if (image3.getAttribute('src') == "./images/off.png" && image2.getAttribute('src') == "./images/on.png" && image1.getAttribute('src') == "./images/off.png" && image0.getAttribute('src') == "./images/off.png") {//4
		vo = (rf / r1) * (vref / 2) * ((b3_3 / 1) + (b2_2 / 2) + (b1_1 / 4) + (b0_0 / 8));
		//vo=(rf/r1)*((vref*b3_3/1)+(vref*b2_2/2)+(vref*b1_1/4)+(vref*b0_0/8));
		//resln=(rf/r1)*(vref*b0_0/8);//weighting of LSB     
		resln = (vref / 16);//weighting of LSB
	...
	if (image3.getAttribute('src') == "./images/off.png" && image2.getAttribute('src') == "./images/on.png" && image1.getAttribute('src') == "./images/off.png" && image0.getAttribute('src') == "./images/on.png") {//5
		vo = (rf / r1) * (vref / 2) * ((b3_3 / 1) + (b2_2 / 2) + (b1_1 / 4) + (b0_0 / 8));
		//vo=(rf/r1)*((vref*b3_3/1)+(vref*b2_2/2)+(vref*b1_1/4)+(vref*b0_0/8));
		//resln=(rf/r1)*(vref*b0_0/8);//weighting of LSB    
		resln = (vref / 16);//weighting of LSB
	...
	if (image3.getAttribute('src') == "./images/off.png" && image2.getAttribute('src') == "./images/on.png" && image1.getAttribute('src') == "./images/on.png" && image0.getAttribute('src') == "./images/off.png") {//6
		vo = (rf / r1) * (vref / 2) * ((b3_3 / 1) + (b2_2 / 2) + (b1_1 / 4) + (b0_0 / 8));
		//vo=(rf/r1)*((vref*b3_3/1)+(vref*b2_2/2)+(vref*b1_1/4)+(vref*b0_0/8));
		//resln=(rf/r1)*(vref*b0_0/8);//weighting of LSB  
		resln = (vref / 16);//weighting of LSB
	...
	if (image3.getAttribute('src') == "./images/off.png" && image2.getAttribute('src') == "./images/on.png" && image1.getAttribute('src') == "./images/on.png" && image0.getAttribute('src') == "./images/on.png") {//7
		//alert(b0_0);
		vo = (rf / r1) * (vref / 2) * ((b3_3 / 1) + (b2_2 / 2) + (b1_1 / 4) + (b0_0 / 8));
		//vo=(rf/r1)*((vref*b3_3/1)+(vref*b2_2/2)+(vref*b1_1/4)+(vref*b0_0/8));
		//resln=(rf/r1)*(vref*b0_0/8);//weighting of LSB 
	...
	if (image3.getAttribute('src') == "./images/on.png" && image2.getAttribute('src') == "./images/off.png" && image1.getAttribute('src') == "./images/off.png" && image0.getAttribute('src') == "./images/off.png") {//8
		//alert(b0_0);
		vo = (rf / r1) * (vref / 2) * ((b3_3 / 1) + (b2_2 / 2) + (b1_1 / 4) + (b0_0 / 8));
		//vo=(rf/r1)*((vref*b3_3/1)+(vref*b2_2/2)+(vref*b1_1/4)+(vref*b0_0/8));
		//resln=(rf/r1)*(vref*b0_0/8);//weighting of LSB  
	...
	if (image3.getAttribute('src') == "./images/on.png" && image2.getAttribute('src') == "./images/off.png" && image1.getAttribute('src') == "./images/off.png" && image0.getAttribute('src') == "./images/on.png") {//9
		//alert(b0_0);
		vo = (rf / r1) * (vref / 2) * ((b3_3 / 1) + (b2_2 / 2) + (b1_1 / 4) + (b0_0 / 8));
		//vo=(rf/r1)*((vref*b3_3/1)+(vref*b2_2/2)+(vref*b1_1/4)+(vref*b0_0/8));
		//resln=(rf/r1)*(vref*b0_0/8);//weighting of LSB      
	...
	if (image3.getAttribute('src') == "./images/on.png" && image2.getAttribute('src') == "./images/off.png" && image1.getAttribute('src') == "./images/on.png" && image0.getAttribute('src') == "./images/off.png") {//10
		//alert(b0_0);
		vo = (rf / r1) * (vref / 2) * ((b3_3 / 1) + (b2_2 / 2) + (b1_1 / 4) + (b0_0 / 8));
		//vo=(rf/r1)*((vref*b3_3/1)+(vref*b2_2/2)+(vref*b1_1/4)+(vref*b0_0/8));
		//resln=(rf/r1)*(vref*b0_0/8);//weighting of LSB   
	...
	if (image3.getAttribute('src') == "./images/on.png" && image2.getAttribute('src') == "./images/off.png" && image1.getAttribute('src') == "./images/on.png" && image0.getAttribute('src') == "./images/on.png") {//11
		//alert(b0_0);
		vo = (rf / r1) * (vref / 2) * ((b3_3 / 1) + (b2_2 / 2) + (b1_1 / 4) + (b0_0 / 8));
		//vo=(rf/r1)*((vref*b3_3/1)+(vref*b2_2/2)+(vref*b1_1/4)+(vref*b0_0/8));
		//resln=(rf/r1)*(vref*b0_0/8);//weighting of LSB   
	...
	if (image3.getAttribute('src') == "./images/on.png" && image2.getAttribute('src') == "./images/on.png" && image1.getAttribute('src') == "./images/off.png" && image0.getAttribute('src') == "./images/off.png") {//12
		//alert(b0_0);
		vo = (rf / r1) * (vref / 2) * ((b3_3 / 1) + (b2_2 / 2) + (b1_1 / 4) + (b0_0 / 8));
		//vo=(rf/r1)*((vref*b3_3/1)+(vref*b2_2/2)+(vref*b1_1/4)+(vref*b0_0/8));
		//resln=(rf/r1)*(vref*b0_0/8);//weighting of LSB  
	...
	if (image3.getAttribute('src') == "./images/on.png" && image2.getAttribute('src') == "./images/on.png" && image1.getAttribute('src') == "./images/off.png" && image0.getAttribute('src') == "./images/on.png") {//13
		//alert(b0_0);
		vo = (rf / r1) * (vref / 2) * ((b3_3 / 1) + (b2_2 / 2) + (b1_1 / 4) + (b0_0 / 8));
		//vo=(rf/r1)*((vref*b3_3/1)+(vref*b2_2/2)+(vref*b1_1/4)+(vref*b0_0/8));
		//resln=(rf/r1)*(vref*b0_0/8);//weighting of LSB  
	...
	if (image3.getAttribute('src') == "./images/on.png" && image2.getAttribute('src') == "./images/on.png" && image1.getAttribute('src') == "./images/on.png" && image0.getAttribute('src') == "./images/off.png") {//14
		//alert(b0_0);
		vo = (rf / r1) * (vref / 2) * ((b3_3 / 1) + (b2_2 / 2) + (b1_1 / 4) + (b0_0 / 8));
		//vo=(rf/r1)*((vref*b3_3/1)+(vref*b2_2/2)+(vref*b1_1/4)+(vref*b0_0/8));
		//resln=(rf/r1)*(vref*b0_0/8);//weighting of LSB    
	...
	if (image3.getAttribute('src') == "./images/on.png" && image2.getAttribute('src') == "./images/on.png" && image1.getAttribute('src') == "./images/on.png" && image0.getAttribute('src') == "./images/on.png") {//15
		//alert(b0_0);
		vo = (rf / r1) * (vref / 2) * ((b3_3 / 1) + (b2_2 / 2) + (b1_1 / 4) + (b0_0 / 8));
		//vo=(rf/r1)*((vref*b3_3/1)+(vref*b2_2/2)+(vref*b1_1/4)+(vref*b0_0/8));
		//resln=(rf/r1)*(vref*b0_0/8);//weighting of LSB      
